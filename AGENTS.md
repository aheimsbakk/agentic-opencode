...
- **Structure:** `./BLUEPRINT.md` = Current Architecture, Data Models. `./CONTEXT.md` = Overview, Dependencies. `./STATUS.md` = Current work, last decision, next steps. Keep all brutally short.
- **No Coding or Pseudocode:** `BLUEPRINT.md`, `CONTEXT.md`, `STATUS.md`, and `PROJECT_RULES.md` must NEVER contain application source code, pseudocode, algorithmic logic, scripts, or config files. Write only high-level concepts, file paths, schemas, and API signatures.
